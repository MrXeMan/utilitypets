...
import me.mrxeman.utilitypets.entity.FireCoalEntity;
...
public class FireCoalRenderer extends EntityRenderer<FireCoalEntity> {
    private static final ResourceLocation TEXTURE_LOCATION = ResourceLocation.fromNamespaceAndPath(MOD_ID, "textures/entity/fiery_coal.png");
    private static final RenderType RENDER_TYPE = RenderType.entityCutoutNoCull(TEXTURE_LOCATION);

    public FireCoalRenderer(EntityRendererProvider.Context p_173962_) {
        super(p_173962_);
    }

    protected int getBlockLightLevel(@NotNull FireCoalEntity p_114087_, @NotNull BlockPos p_114088_) {
        return 15;
    }

    public void render(@NotNull FireCoalEntity p_114080_, float p_114081_, float p_114082_, PoseStack p_114083_, MultiBufferSource p_114084_, int p_114085_) {
        p_114083_.pushPose();
    ...
    public @NotNull ResourceLocation getTextureLocation(@NotNull FireCoalEntity p_114078_) {
